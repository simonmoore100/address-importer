...
router.get('/', function(req, res, next) {
    ...
    csv.fromPath(config.inputAddressFilePath + config.inputAddressFileName, {
            headers: true
        })
        .on("data", function(data) {
            ...
            if (building_status === 'BUILT' || building_status === 'NONE' || building_status === 'UNDER CONSTRUCTION') {
                if (address_status === 'APPROVED' || address_status === 'CANDIDATE' || address_status === 'PROVISIONAL') {
                    if (classification === 'DO_APART' || classification === 'DO_DETACHED' || classification === 'DO_OTHER' || classification === 'DO_SEMI' || classification === 'DO_TERRACE' || classification === 'ND_HEALTH' || (classification === '' && organisation_name === '')) {
